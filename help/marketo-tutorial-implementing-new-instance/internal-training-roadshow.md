...
|--- |--- |--- |--- |
| Overzicht van marketingactiviteiten | <ul><li>Updates en verantwoordelijkheden van het team voor marketingactiviteiten</li><li>Overzicht van de Stapel en processen van de Technologie van de Marketing</li><li>Campagne maken (end-to-end)</li><li>Huidige processen controleren om hiaten te identificeren/te overbruggen</li></ul> | Persoonlijk overzicht, hand op wandelen van Marketo Engage, opiniepeiling van huidige processen en wil | 2,5 u |
| Marketo Engage Walkthrough | <ul><li>Doorloop op hoog niveau van Marketo Engage</li><li>Typen campagnes en naamgevingsconventies</li><li>Marketo Engage + CRM-integratie | Live demo, naamgeving van de conventie-werksessie, gastsessie met verkoopactiviteiten, | 1,5 u |
| E-mails + bestemmingspagina&#39;s | <ul><li>Overzicht van sjablonen voor e-mail- en landingspagina&#39;s</li><li>Voorbeelden van actieve bestemmingspagina&#39;s</li><li>De publiekscriteria en doel-URL&#39;s van dialoogvensters definiëren</li><li>Aanbevolen werkwijzen voor het aanmaken van e-mail en landingspagina</li></ul> | Live werkkoppelingen, interactieve voorbeelden, overzicht van best practices uit de branche | 1h |
| Gebeurtenisbeheer en webinar-integratie | Registratiepagina&#39;s + iPad-incheckapp | Live demo van webinar-registratieproces en iPad-app voor inchecken | 1h |
|  | Interactief webinar | Live demo over het maken, beheren en leveren van gebeurtenissen in Marketo Engage | 1h |
| Automatisering van gesprekken + integratie van chatbot-oplossing | <ul><li>Chat activeren als een nieuw marketingkanaal</li><li>Dynamic Chat - installeren van chatboardfragment, maken en publiceren van automatische dialoogvensters</li></ul> | Opgenomen video van het maken van Dialogen en het ontwikkelen van publiekscriteria, overzicht van stroomontwerper | 1h |
| Marketo Sales Insight | <ul><li>E-mails verzenden en volgen vanuit Marketo Sales Insight</li><li>Insteekmodule MSI Outlook</li></ul> | Opgenomen video van end-to-end proces voor gemakkelijke distributie aan nieuwe werknemers | 1h |
